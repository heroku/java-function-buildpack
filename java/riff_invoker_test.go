...
func TestRiffInvoker(t *testing.T) {
	...
	//			g.Expect(java.BuildPlanContribution(f.Detect, function.Metadata{Handler: "test-handler"})).To(Equal(buildplan.Plan{
	...
	//				Metadata: buildpackplan.Metadata{java.Handler: "test-handler"},
	//			}
	//			f.AddPlan(plan)
	//
